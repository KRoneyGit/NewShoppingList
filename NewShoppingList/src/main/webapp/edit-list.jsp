...
<body>
	<form action = "editListDetailsServlet" method="post">
		...
		ListName: <input type="text" name="listName" value="${listToEdit.listName}"><br />
		...
		Shopper Name: <input type="text" name="shopperName" value="${listToEdit.shopper.shoperName}"><br />
